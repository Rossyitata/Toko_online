    ...
    <div class="container">
        ...
        <div class="row">
            ...
            while ($dt_produk = mysqli_fetch_array($qry_produk)) {
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img src="asset/foto_produk/<?= $dt_produk['foto_produk'] ?>" class="card-img-top">
                        <div class="card-body">
                            <hr>
                            ...
                            <td>
                            <a href="transaksi.php?id_produk=<?= $dt_produk['id_produk'] ?>"
                            class="btn btn-success">Tambah ke Keranjang</a>
                            </td>
                        </div>
                    </div>
                </div>
