      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="tampil_admin.php">Data Pegawai</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="tampil_pelanggan.php">Data Pelanggan</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="tampil_transaksi_petugas.php">Histori Transaksi</a>
            </li>
            <li class="nav-item">
