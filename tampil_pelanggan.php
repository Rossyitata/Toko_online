...
<body>
    ...
    <div class="container">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="text-center">
                            ...
                            <img src="asset/foto_pelanggan/<?= $data_pelanggan['foto'] ?>" class="profile-img" alt="Foto Pelanggan">
                        </div>
                        <hr>
        ...
        <div class="text-left mt-4">
            <a href="tambah_pelanggan2.php" class="btn btn-primary">Tambah Pelanggan</a>
        </div>
    </div>
